function Contact() {
    return (
        <div className="max-w-6xl max-lg:max-w-3xl mx-auto bg-white p-4 mt-5"
           
        >
            <div
                className="mt-5 grid lg:grid-cols-2 gap-16 relative overflow-hidden p-8 [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-lg:before:hidden"
            >
                <div>
                    ...
                    <form>
                        ...
                        <button type="button"
                            className="mt-8 flex items-center justify-center text-sm font-medium w-full px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">
